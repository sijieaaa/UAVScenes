...
- We include camera (Hikvision) images , LiDAR (Livox Avia) point clouds, annotations, 6-DoF poses. More sensor and scene information can be found from [MARS-LVIG](https://mars.hku.hk/dataset.html).
